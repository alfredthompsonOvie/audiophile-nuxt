				...
				<template v-if="productDetail">
					<section class="product__DetailsPage__contents">
						<section class="product__details">
							<picture>
								<!-- <source
									:srcset="`${getImageUrl(
										product[0].detailsPreviewImage.desktop
									)}`"
									media="(min-width: 992px)"
								/>
								<source
									:srcset="`${getImageUrl(
										product[0].detailsPreviewImage.tablet
									)}`"
									media="(min-width: 600px)"
								/>
								<img
									:src="`${getImageUrl(
										product[0].detailsPreviewImage.mobile
									)}`"
									alt=""
								/> -->
							</picture>
							<section class="product__content">
								<small class="product__new" v-if="product[0].new">
									new product</small
								>
								...
								<p class="price">$ {{ formatNumber(product[0].price) }}</p>
						...
						<section class="features">
							<section class="features__description">
								...
								<p
									v-for="feature in product[0].features"
									:key="feature"
									class="description"
								>
									{{ feature }}
							...
							<section class="contents">
								...
								<div>
									<div
										v-for="content in product[0].contents"
										:key="content"
									>
					...
					<section class="showcase">
						<picture class="showcase--one">
							...
							<img
								:src="`${getImageUrl(product[0].showcase[0].mobile)}`"
								alt=""
							/>
						...
						<picture class="showcase--two">
							...
							<source srcset="" media="(min-width: 600px)" />
							<img
								:src="`${getImageUrl(product[0].showcase[1].mobile)}`"
								alt=""
							/>
						</picture>
						...
						<source :srcset="`${getImageUrl(productDetail[0].showcase[2].tablet)}`" media="(min-width: 600px)"> -->
							...
							<source srcset="" media="(min-width: 600px)" />
							<img
								:src="`${getImageUrl(product[0].showcase[2].mobile)}`"
								alt=""
							/>
						</picture>
					</section>
					...
					<section class="moreProduct">
						...
						<section class="card__container">
							<section
								v-for="prod in product[0].otherProducts"
								:key="prod.title"
								class="card"
							>
								<picture class="showcase--two">
...
const product = jsonData.filter((el) => el.slug === route.params.id);
